...
class BaseSolver(object):
    ...
    def train(self, ):
        ...
        self.train_dataloader = dist.warp_loader(self.cfg.dataset, mode="train", batch_size=8, num_workers=16, augment=True, shuffle=True)
        self.val_dataloader = dist.warp_loader(self.cfg.dataset, mode="val", batch_size=8, num_workers=16, augment=False, shuffle=False)
